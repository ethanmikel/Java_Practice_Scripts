...
public class Magpie4
{
    ...
    {
        return "\nHello, my name is Arnold, your virtual friend. If you would like to end our conversation at any time just say Bye.";
    }
    ...
    public String getResponse(String statement)
    {
        ...
        {
            response = "Why are you not very sure?";
        } 
        else if (findKeyword(statement, "I don't know") >= 0
                || findKeyword(statement, "I'm not sure") >= 0)
        {
            response = "Why don't you know?";
        }
        else if (findKeyword(statement, "Hello") >= 0
                || findKeyword(statement, "hello") >= 0)
                
        {
            response = "Hello, and how are you?";
        }
        ...
        else if (findKeyword(statement, "Mrs. Feeney") >= 0
                || findKeyword(statement, "Mr. Knott") >= 0
                || findKeyword(statement, "Mr. Lawler") >= 0
                || findKeyword(statement, "Mrs. Carter") >= 0)
        {
            response = ("Is this your favorite teacher?");
        }
                ...
                || findKeyword(statement, "cheeseburger") >= 0)
        {
            response = ("Is that your favorite food?");
                ...
                || findKeyword(statement, "writing") >= 0)
        {
            response = ("Is this what you do for fun?");
        }
        else if (findKeyword(statement, "flip a coin") >= 0)
        {
    ...
    */
       ...
       //  Removes the puncation in the sentence, if there is one
	...
	//  Remove the puncation in the sentence, if there is one
